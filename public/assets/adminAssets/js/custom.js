...
$(document).ready(function() {
    ...
    var footerPart = $(".footer_part");
    var lastSidebarState = localStorage.getItem("sidebar_state");
    if (lastSidebarState === "mini") {
        sidebar.addClass("mini_sidebar");
        mainContent.addClass("full_main_content");
        footerPart.addClass("full_footer");
    } else if (lastSidebarState === "full") {
        sidebar.removeClass("mini_sidebar");
        mainContent.removeClass("full_main_content");
        footerPart.removeClass("full_footer");
    }
});

// Unified mini sidebar toggle with localStorage
...
// #NOTIFICATION_ 
    ...
    $('.sidebar_close_icon i').on('click', function(){
        $('.sidebar').removeClass('active_sidebar mini_sidebar');
