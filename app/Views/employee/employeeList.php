                            ...
                            <div class="white_box_tittle list_header">
                                ...
                                <div class="box_right d-flex lms_block">                                    
                                    <div class="add_button ms-2">
                                        <a href="<?= base_url('employeeAdd') ?>" class="btn btn-primary"><i class="fas fa-plus"> </i></a>                                        
                                    </div>
                                </div>
                            </div> 
                                            ...
                                            <tr>
                                                ...
                                                <td><?= esc($data['designation'] ?? '') ?>
                                                    <small class="d-block text-muted">
                                                        <?php $use_for = ($data['use_for'] === 'S') ? ' (School)' : 
                                                                            (($data['use_for'] === 'A') ? ' (Admin)' : 
                                                                            (($data['use_for'] === 'L') ? ' (Library)' : null));
                                                                            ?>
                                                        <?= esc($data['user_type'] ?? '') ?><?= esc($use_for ?? '') ?>
                                                    </small>
                                                </td>                                                
                                                <td>
                                                ...
                                                <td class="no-export">
                                                    ...
                                                    <div class="btn-group mb-3">
                                                        ...
                                                        <div class="dropdown-menu compact-dropdown">                                                            
                                                            <a class="dropdown-item btn-font" href="employee/edit/<?= esc($data['id']) ?>"> <i class="fas fa-edit"></i> Edit</a>
                                                            <a class="dropdown-item btn-font" href="javascript:void(0);" onclick="openResetPasswordModal(<?= $data['id'] ?>, '<?= esc($data['username']) ?>')"> <i class="ti-solid ti-key"></i> Reset Password</a>
                                                            <a class="dropdown-item btn-font" href="employee/assign_role_to_user/<?= esc($data['id']) ?>"> <i class="ti-book"></i> Assign Role</a>
                                                            <a class="dropdown-item btn-font" href="/user_menu_access/<?= $data['id']?>" ><i class="fab fa-gg"></i> Assign Access</a>
                                                            <form action="<?= site_url('employee/delete/' . $data['id']) ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this user?')">
                                                                <?= csrf_field() ?>
