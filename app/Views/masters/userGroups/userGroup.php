                                        ...
                                        <tbody>                                            
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    data-id="<?= esc($data['id']) ?>" data-tbl="auth_groups"  
                                                ...
                                                <td class="no-export">
                                                    ...
                                                    <div class="btn-group mb-3">
                                                        ...
                                                        <div class="dropdown-menu compact-dropdown">                                                            
                                                            ...
                                                            <a class="dropdown-item btn-font" href="userGroups/user_type_menu_access/<?= $data['id']?>" ><i class="fab fa-gg"></i> Assign Access</a>
                                                ...
                                                <!-- <td >
                                                    <a href="/user_type_menu_access/<?= $data['id']?>" ><i class="fab fa-gg"></i> Assign Access</a>                                                    
                                                </td>                                                 -->
                                            </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
