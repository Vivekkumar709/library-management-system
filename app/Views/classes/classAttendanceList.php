                            ...
                            <div class="white_box_tittle list_header">
                                ...
                                <div class="box_right d-flex lms_block">                                    
                                    <div class="add_button ms-2">
                                        <a href="<?= base_url('classes/addClassAttendance/'.service('uri')->getSegment(3)) ?>" class="btn btn-primary"><i class="fas fa-plus"> </i></a>                                        
                                    </div>
                                </div>
                            </div> 
                                                ...
                                                <td class="no-export">
                                                    ...
                                                    <div class="btn-group mb-3">
                                                        ...
                                                        <div class="dropdown-menu compact-dropdown">                                                            
                                                            <a class="dropdown-item btn-font" href="teacher/edit/<?= esc($data['id']) ?>"> <i class="fas fa-edit"></i> Edit</a>
