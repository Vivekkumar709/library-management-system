    ...
    <style>
        * {
        ...
        .btn-primary {
            background: #6f5b92;
            color: white;
            border: 2px solid #6f5b92;
        }
        .btn-primary:hover {
            background: #5a4a7a;
            transform: translateY(-3px);
            box-shadow: 0 5px 15px rgba(111, 91, 146, 0.4);
        }
        .btn-secondary {
        ...
        .btn-secondary:hover {
            background: rgba(111, 91, 146, 0.1);
            transform: translateY(-3px);
        }
        /* SVG Styles */
        .cls-1 {
    ...
    <div class="container">
        <div class="error-content">
            <div class="error-message">
                ...
                <div class="buttons">
                    <a href="/dashboard" class="btn btn-primary">Go to Homepage</a>
                    <!-- <a href="history.back()" class="btn btn-secondary">Go Back</a> -->
                </div>
            </div>
            <div class="error-illustration">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
                    <!-- SVG content remains the same as in your original code -->
                    ...
                    <g id="cup" data-name="Layer 7">
                        ...
                        <path class="cls-8" d="M1172.73,709.70l23.58-23.85a4.19,4.19,0,0,1,5.92,0h0a4.19,4.19,0,0,1,0,5.92l-23.58,23.85Z"/>
                        <path class="cls-8" d="M1185.11,722.09l23.58-23.85a4.19,4.19,0,0,1,5.92,0h0a4.19,4.19,0,0,1,0,5.92L1191.06,728Z"/>
                        </g>
                        <path class="cls-5" d="M1197.85,660.50h45.69a5.7,5.7,0,0,1,5.7,5.7v8.32a0,0,0,0,1,0,0h-57.09a0,0,0,0,1,0,0v-8.32A5.7,5.7,0,0,1,1197.85,660.50Z" transform="translate(829.53 -667.66) rotate(45)"/>
                    ...
                    <g id="rucksack" data-name="Layer 6">
                        ...
                        <path class="cls-8" d="M1296.76,603.8,1215,618.92l-4.89-28.77c-2.11-12.42,5.83-24.27,17.73-26.47l38.67-7.15c11.90-2.20,23.26,6.08,25.37,18.50Z"/>
                        <path class="cls-5" d="M1296.76,603.8l-73.41,13.58-4.92-29c-2-11.62,5.45-22.72,16.60-24.78l33.07-6.12c11.14-2.06,21.77,5.69,23.75,17.32Z"/>
